...
{
	$array['blockTagsShowType'] = filter_text_input( 'blockTagsShowType', 'post', 'random', 1, 255 );
...
{
	$xtpl->assign( 'BLOCKTAGSSHOWTYPE', array( "key" => $type, "title" => $BL->lang('cfgblockTagsShowType_' . $type), "selected" => $type == $BL->setting['blockTagsShowType'] ? " selected=\"selected\"" : "" ) );
