    ...
    <div class="row">
        <div class="col-md-16 col-lg-18">
            ...
            <div class="clearfix" id="mediaheight-wrap">
                ...
                <dl class="bl-post-dl">
                    <dt class="aright"><label for="mediaresponsive">{LANG.blogMediaResponsive}:</label></dt>
                    <dd><input type="checkbox" name="mediaresponsive" id="mediaresponsive" value="1"{DATA.mediaresponsive}/></dd>
                </dl>
                <dl class="bl-post-dl">
                    <dt class="aright"><label for="mediawidth">{LANG.blogMediaWidth}:</label></dt>
                    <dd><input type="text" class="form-control bl-txt-q" name="mediawidth" id="mediawidth" value="{DATA.mediawidth}"/></dd>
                </dl>
            </div>
...
function mediaHandle() {
    ...
    if (mediatype != '2' && mediatype != '3' && mediatype != 4) {
        ...
        $('#mediawidth').attr('disabled', 'disabled');
        $('#mediaresponsive').attr('disabled', 'disabled');
        $('#mediaheight-wrap').hide();
    } else {
        $('#mediaheight').removeAttr('disabled');
        $('#mediawidth').removeAttr('disabled');
        $('#mediaresponsive').removeAttr('disabled');
...
$(document).ready(function() {
    ...
    $('.bl-post-panel .tl').click(function() {
        ...
        if ($this.hasClass('collapse')) {
            $this.find('.ct').slideDown(200, function() {
                $this.removeClass('collapse').addClass('decollapse')
            });
        } else {
            $this.find('.ct').slideUp(200, function() {
                $this.removeClass('decollapse').addClass('collapse')
            });
        }
    });
